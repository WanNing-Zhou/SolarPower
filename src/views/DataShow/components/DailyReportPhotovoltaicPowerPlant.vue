        ...
        <el-table :header-cell-style="{ 'text-align': 'center' }" :data="tableData" height="380px">
          ...
          <el-table-column label="中铁">
            <el-table-column prop="zhongtie.dailyOperationStatus" label="当天运行情况" width="120">
              <template #default="scope">
                <el-input size="small" v-if="scope.row.edit" v-model="scope.row.zhongtie.dailyOperationStatus"></el-input>
            ...
            <el-table-column prop="zhongtie.dailyPowerGeneration" label="日发电量Mwh" width="120">
              <template #default="scope">
                <el-input size="small" v-if="scope.row.edit" v-model="scope.row.zhongtie.dailyPowerGeneration"></el-input>
          ...
          <el-table-column label="菲尔特">
            <el-table-column prop="feierte.dailyOperationStatus" label="当天运行情况" width="120">
              <template #default="scope">
                <el-input size="small" v-if="scope.row.edit" v-model="scope.row.feierte.dailyOperationStatus"></el-input>
                <span v-else>{{ scope.row.feierte.dailyOperationStatus }}</span>
              </template>
            </el-table-column>
            <el-table-column prop="feierte.dailyPowerGeneration" label="日发电量Mwh" width="120">
              <template #default="scope">
                <el-input size="small" v-if="scope.row.edit" v-model="scope.row.feierte.dailyPowerGeneration"></el-input>
                <span v-else>{{ scope.row.feierte.dailyPowerGeneration }}</span>
              </template>
            </el-table-column>
